(function createLinkbackBar() {
    ...
    function writeText() {
        ...
        if (language === 'es') {
            ...
            finalText = '<head><link rel="stylesheet" href="//fonts.googleapis.com/css?family=Noto+Sans" /><style>body {margin: 0; background: #F1F1F1; border-bottom: 1px #999999 solid;}a {color: #333333; text-decoration: none; font-size: 10px; font-family: "Noto Sans", Arial, sans-serif}a:hover {text-decoration: underline;}#returnToNCInav {height: 100%; display:block; line-height: 25px; text-align: center;}</style><body><nav id="returnToNCInav"><a target="_new" tabindex="1" id="returnToNCIlink--home" href="https://datascience.cancer.gov/data-commons?cid=cgovnav_hp_' + site + '">NCI Cancer Research Data Commons</a></nav></body>';
        }
        return finalText;
    }
