(function createLinkbackBar() {
    ...
    var linkback = create('iframe', {
        id: 'returnToNCIframe',
        title: 'Link to Research 4 Resources',
        width: '100%',
        height: '24px',
        scrolling: 'no'
    });
    ...
    var content = '<head>' +
        ...
        '<a target="' + linktarget + '" tabindex="1" id="returnToNCIlink--home" href="https://www.cancer.gov/research/resources?cid=cgovnav_hp_' + site + '">NCI Resources for Researchers</a>' +
        '</nav>' +
        '</body>';
